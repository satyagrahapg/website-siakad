<!-- Ubah Guru Modal -->
<div class="modal fade" data-bs-backdrop="static" id="viewGuruModal-{{ $guru->id }}" tabindex="-1" aria-labelledby="editGuruModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="nama" id="nama" class="form-control" readonly value="{{ old('nama', $guru->nama) }}" required disabled>
                    </div>

                    <div class="form-group mb-3">
                        <label for="nip">NIP / Kode Pegawai</label>
                        <input type="text" name="nip" id="nip" class="form-control" readonly value="{{ old('nip', $guru->nip) }}" required disabled>
                    </div>

                    <div class="form-group mb-3">
                        <label for="gelar_depan">Gelar Depan</label>
                        <input type="text" name="gelar_depan" id="gelar_depan" class="form-control" readonly value="{{ old('gelar_depan', $guru->gelar_depan) }}" placeholder="-" disabled>
                    </div>

                    <div class="form-group mb-3">
                        <label for="gelar_belakang">Gelar Belakang</label>
                        <input type="text" name="gelar_belakang" id="gelar_belakang" class="form-control" readonly value="{{ old('gelar_belakang', substr($guru->gelar_belakang, 2)) }}" placeholder="-" disabled>
                    </div>

                    <div class="form-group mb-3">
                        <label for="tempat_lahir">Tempat Lahir</label>
                        <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control" readonly value="{{ old('tempat_lahir', $guru->tempat_lahir) }}" required placeholder="-" disabled>
                    </div>

                    <div class="form-group mb-3">
                        <label for="tanggal_lahir">Tanggal Lahir</label>
                        <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control" readonly value="{{ old('tanggal_lahir', $guru->tanggal_lahir) }}" required placeholder="-" disabled>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="alamat" id="alamat" class="form-control" readonly value="{{ old('alamat', $guru->alamat) }}" required placeholder="-" disabled>
                    </div>

                    <div class="form-group mb-3">
                        <label for="jabatan">Jabatan</label>
                        <input type="text" name="jabatan" id="jabatan" class="form-control" readonly value="{{ old('jabatan', $guru->jabatan) }}" required placeholder="-" disabled>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="pendidikan" id="pendidikan" class="form-control" readonly value="{{ old('pendidikan', $guru->pendidikan) }}" required placeholder="-" disabled>
                    </div>
            </div>
        </div>
    </div>
