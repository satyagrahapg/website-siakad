        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="nip" id="nip" class="form-control" readonly disabled
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control" readonly disabled
                        value="{{ old('tempat_lahir', $a->tempat_lahir) }}" placeholder="-" required>
                </div>

                <div class="form-group mb-3">
                    <label for="tanggal_lahir">Tanggal Lahir</label>
                    <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control" readonly disabled
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="jenis_kelamin" id="jenis_kelamin" class="form-select" disabled required>
                        <option value="" selected disabled hidden> - </option>s
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="alamat" id="alamat" class="form-control" readonly disabled
                        value="{{ old('alamat', $a->alamat) }}" placeholder="-" required>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="pendidikan" id="pendidikan" class="form-control" readonly disabled
                        value="{{ old('pendidikan', $a->pendidikan) }}" placeholder="-" required>
                </div>
            </div>
        </div>
    </div>
